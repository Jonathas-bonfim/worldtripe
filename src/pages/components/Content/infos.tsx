        ...
        <Text fontWeight="500" fontSize={["md", "xl"]} color="gray.700">
          ...
          <Popover>
            ...
            <PopoverContent bg="gray.700" color="yellow.400">
              ...
              <PopoverCloseButton />
              <PopoverBody fontWeight="400" fontSize="lg">Londres, Paris, Roma, Praga, Lisboa, Viena, Barcelona, Madrid, Berlim, Budapeste, Istambul, Amsterdã, Copenhage...</PopoverBody>
            </PopoverContent>
          </Popover>
